...
class Ui_MainClientWindow(object):
    ...
    def retranslateUi(self, MainClientWindow):
        ...
        MainClientWindow.setWindowTitle(_translate("MainClientWindow", "Text messenger 0.01a"))
        ...
        self.label_new_message.setText(_translate("MainClientWindow", "Input message:"))
        self.btn_send.setText(_translate("MainClientWindow", "Send message"))
        self.btn_clear.setText(_translate("MainClientWindow", "Clear input field"))
