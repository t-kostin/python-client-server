...
def gui_create_model(database):
    ...
    list_table.setHorizontalHeaderLabels(['Client name', 'IP Address', 'Port', 'Login time'])
...
def create_stat_model(database):
    ...
    hist_list = database.messages_history()

    # Объект модели данных:
    list_table = QStandardItemModel()
    list_table.setHorizontalHeaderLabels(
        ['User name', 'Last logon', 'Messages sent', 'Messages received'])
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.config_btn = QAction('Server configuration', self)
...
class ConfigWindow(QDialog):
    def __init__(self):
        ...
        self.db_file_label = QLabel('Data base file name: ', self)
        ...
        self.ip_label = QLabel('IP Address to accept connections:', self)
        self.ip_label.move(10, 148)
        self.ip_label.setFixedSize(180, 15)

        # Метка с напоминанием о пустом поле.
        self.ip_label_note = QLabel(' Leave blank to accept connection\n from all addresses.', self)
